...
public class StaticCoordinator implements PartitionCoordinator {
    ...
    public StaticCoordinator(DynamicPartitionConnections connections, Map stormConf, SpoutConfig config, ZkDataStore state, int taskIndex, int totalTasks, String topologyInstanceId) {
